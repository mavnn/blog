...
#+BEGIN_SRC css :tangle ../../../../static/org.css
  ...
  .org-src-container:before {
    ...
    width: fit-content;
    padding: 5px;
    border-bottom: solid 1px var(--org-string);
  ...
  */
  ...
  :root {
      ...
      --org-name: #1b1e2b;
      --org-comment: #2c5115;
      --org-punctuation: #2c3114;
  }
  .org-keyword { color: var(--org-keyword); }
  .org-constant { color: var(--org-constant); }
  .org-string { color: var(--org-string); }
  .org-number { color: var(--org-number); }
  .org-type { color: var(--org-type); }
  .org-function-name { color: var(--org-name); }
  .org-variable-name { color: var(--org-name); }
  .org-comment { color: var(--org-comment); }
  .org-comment-delimiter { color: var(--org-comment); }

  /* Add treesitter versions as well */
  .org-tree-sitter-hl-faceXkeyword { color: var(--org-keyword); }
  .org-tree-sitter-hl-faceXconstant { color: var(--org-constant); }
  .org-tree-sitter-hl-faceXstring { color: var(--org-string); }
  .org-tree-sitter-hl-faceXnumber { color: var(--org-number); }
  .org-tree-sitter-hl-faceXtype { color: var(--org-type); }
  .org-tree-sitter-hl-faceXtypeXbuiltin { color: var(--org-type); }
  .org-tree-sitter-hl-faceXfunction { color: var(--org-name); }
  .org-tree-sitter-hl-faceXvariable { color: var(--org-type); }
  .org-tree-sitter-hl-faceXvariableXparameter { color: var(--org-type); }
  .org-tree-sitter-hl-faceXcomment { color: var(--org-comment); }
  .org-tree-sitter-hl-faceXpunctuationXbracket { color: var(--org-punctuation); }
  .org-tree-sitter-hl-faceXpunctuationXdelimiter { color: var(--org-punctuation); }
  .org-tree-sitter-hl-faceXpunctuationXoperator { color: var(--org-punctuation); }
  .org-tree-sitter-hl-faceXpunctuation { color: var(--org-type); }
  .org-tree-sitter-hl-faceXattribute { color: var(--org-type); }
  .org-tree-sitter-hl-faceXtag { color: var(--org-type); }

  /* Override rainbow if it happens to be turned on in my config */
  .org-rainbow-delimiters-depth-1 { color: var(--org-punctuation); }
  .org-rainbow-delimiters-depth-2 { color: var(--org-punctuation); }
  .org-rainbow-delimiters-depth-3 { color: var(--org-punctuation); }
  .org-rainbow-delimiters-depth-4 { color: var(--org-punctuation); }
  .org-rainbow-delimiters-depth-5 { color: var(--org-punctuation); }
  .org-rainbow-delimiters-depth-6 { color: var(--org-punctuation); }
  .org-rainbow-delimiters-depth-7 { color: var(--org-punctuation); }
  .org-rainbow-delimiters-depth-8 { color: var(--org-punctuation); }
  .org-rainbow-delimiters-depth-9 { color: var(--org-punctuation); }

  .org-typescript-access-modifier { color: var(--org-keyword); }
  .org-typescript-primitive { color: var(--org-punctuation); }

  .org-nix-attribute { color: var(--org-type); }
#+END_SRC
