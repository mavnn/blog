...
TypeScript has been designed to make demonstrating correctness as easy as possible when dealing with existing (untyped) JavaScript. (Apart from when you just give up, shrug, and use ~any~.))
