...
In general, you just want to let Effect build that up itself; if we add a second service then the type
...
Note that the types any capture /direct/ dependencies. Here, the ~TranslateGreeting~ service almost
...
you're good, and it won't ask you for any more than that. If you're Effect code is starting to build up
...
Leave you thoughts and comments on the [[https://mastodon.sdf.org/@mavnn/113147588182072037][Mastodon]] announcement post, and I'll engage with them there.
